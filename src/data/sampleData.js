export const sampleEvents = [
    ...
    { id: '4', name: 'Salida',             date: '2025-04-27', total: 15000,   per: 2142.85,participants: 7, estadoEvento: true,  whatsappEnvio: true,  icon: require('../assets/event-icon.png'), address: 'Calle Falsa 123', map: 'https://maps.example.com' },
    { id: '5', name: 'Salida II',          date: '2025-04-26', total: 15000,   per: 2142.85,participants: 7, estadoEvento: true,  whatsappEnvio: false, icon: require('../assets/event-icon.png'), address: 'Calle Falsa 123', map: 'https://maps.example.com' }, 
    { id: '6', name: 'Salida III',         date: '2025-04-25', total: 15000,   per: 2142.85,participants: 7, estadoEvento: true,  whatsappEnvio: true,  icon: require('../assets/event-icon.png'), address: 'Calle Falsa 123', map: 'https://maps.example.com' },
    { id: '7', name: 'Salida IV',          date: '2025-04-28', total: 15000,   per: 2142.85,participants: 7, estadoEvento: true,  whatsappEnvio: false, icon: require('../assets/event-icon.png'), address: 'Calle Falsa 123', map: 'https://maps.example.com' },
  ];
  ...
  export const sampleEventsParticipants = [
    ...
    { id: '8', participantsId: '4',  eventsId:'4' },
    // … más participantes …
  ];
  ...
  export const sampleGastos = [
    ...
    { id: '3', descripcion: 'Bebida',  monto:'25752.50',eventsParticipantsId: '1',  date: '2025-04-10' },
    { id: '4', descripcion: 'Bebida',  monto:'25752.50',eventsParticipantsId: '6',  date: '2025-04-10' },
    { id: '5', descripcion: 'Bebida',  monto:'25752.50',eventsParticipantsId: '3',  date: '2025-04-10' },
    // … más participantes …
  ];